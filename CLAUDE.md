...
- **Pixi-герой (спека CDO [sunset], 06.09).** Решение в `<head>`: нет reduced-motion и есть
  ...
  открывается с третьего кадра или через 700 мс после первого, что раньше; плюс страховка по
  времени: через 4 с от старта сцены при frames<3 канвас снимается (CDO [iris62]). Итого «2 с
  после старта сцены по кадрам и не дольше 4 с в любом случае». Rig несёт хеш
